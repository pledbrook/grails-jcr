...
class CrudOperationTests extends AbstractJcrPluginTest {
    Class domainClass
    ...
    void testUpdate() {
        ...
        assertEquals "0", wikiEntry.version
        ...
        assertEquals "1.0", wikiEntry2.version
        ...
        assertEquals "1.1", wikiEntry2.version
    }

    @BeforeClass(dependsOnMethods = ["configureEnvironment"])
    void setUp() {
